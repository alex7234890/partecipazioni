...
function CopyField({ label, value }) {
  ...
  return (
    <div style={{
      ...
      padding: '12px 0',
      borderBottom: '1px solid rgba(139,150,64,0.12)',
    }}>
      <div>
      ...
      <button
        ...
        style={{
          ...
          border: `1px solid ${copied ? 'rgba(80,160,80,0.5)' : 'rgba(139,150,64,0.35)'}`,
          color: copied ? '#4a9a5a' : '#8B9640',
    ...
    <section className="py-24 px-4">
      ...
      >
        <div style={{
          ...
          {/* Angolini */}
          <div style={{ position: 'absolute', top: 8, left: 8, width: 14, height: 14, borderTop: '1px solid rgba(139,150,64,0.40)', borderLeft: '1px solid rgba(139,150,64,0.40)' }}/>
          <div style={{ position: 'absolute', bottom: 8, right: 8, width: 14, height: 14, borderBottom: '1px solid rgba(139,150,64,0.40)', borderRight: '1px solid rgba(139,150,64,0.40)' }}/>
